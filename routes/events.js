...
router.post("/:id/join", passport.authenticate("jwt", { session: false }), uploadImageServerMiddleware, verifyTextMiddleware("caption"),
  verifyImage, uploadImageCloudinaryMiddleware, (req, res) =>
